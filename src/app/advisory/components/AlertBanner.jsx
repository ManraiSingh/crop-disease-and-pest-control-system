  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-[10px] font-bold tracking-wide text-orange-500 uppercase">Important Alert</p>
        <p className="text-sm font-bold text-black">High Temperature Warning</p>
