...
import AboutYourself from "./pages/onboarding/AboutYourself.jsx";
import AddField from "./pages/onboarding/AddField.jsx";
import ComingSoon from "./pages/onboarding/ComingSoon.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/onboarding/crop" element={<ComingSoon />} />
      </Routes>
    </BrowserRouter>
  );
}
